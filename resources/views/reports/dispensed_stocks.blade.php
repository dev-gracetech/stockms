...
<div id="printable-area">
    <h1 id="report-title">Dispensed Stocks by Branches</h1>
    <div class="no-print">
    <form action="{{ route('reports.dispensed-stocks') }}" method="GET" class="mb-3">
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <label for="start_date">Dispensed Start Date</label>
                <input type="date" name="start_date" id="start_date" class="form-control" value="{{ request('start_date') }}">
            </div>
            <div class="col-md-3">
                <label for="end_date">Dispensed End Date</label>
        ...
        <tbody>
            @foreach($stockMovements as $movement)
                ...
                <tr>
                    ...
                    <td>{{ $movement->fromBranch->name ?? '' }}</td>
